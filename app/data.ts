...
export type Resource = { id: string; type: ResourceType; title: string; author: string; meta: string; level: Difficulty | "Not assessed"; url: string; art: string; reason?: string; youtubeKind?: YouTubeKind; youtube?: { channelId: string; durationSeconds?: number; publishedAt?: string; videoCount?: number }; topics?: string[]; matchContext?: "topic" | "path"; provenance?: { kind: "curated" | "web-search"; provider?: DiscoveryProvider; sourceTitle: string; sourceUrl: string; checkedAt: string }; book?: { authors: string; publisher?: string; year?: string; isbn?: string } };
