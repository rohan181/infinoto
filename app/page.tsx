...
export default function Home() {
  ...
  function createNodePath(path: LearningPath) {
    setWorkspace(s => ({ ...s, paths: [...s.paths, path], activeId: path.id }));
    setPage("map");
    setToast(`Created ${path.title}. You can expand every node in this path.`);
